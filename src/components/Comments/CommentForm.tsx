        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-lg bg-gray-900 px-4 py-2 text-white transition hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-gray-900 transition hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700">
